...
print("---------------------------------------------")
print("          Running LocalHERA Part 15          ")
print("---------------------------------------------")
...
for (n in seq(1,length(ss),by = 5)){
  if (n < length(ss)+1){
    ...
    print(Gap_Info)
    setwd(Gap_Info)
    system(paste("cat", paste0(Gap_Info,"*.las > All.las")), wait = F) #9
    setwd("../")
  }
  if (n+1 < length(ss)+1){
    i <- ss[n+1]
  ...
  if (n+4 < length(ss)+1){
    ...
    print(Gap_Info)
    setwd(Gap_Info)
    system(paste("cat", paste0(Gap_Info,"*.las > All.las")), wait = T) #9
    setwd("../")
  }
}

print("----------------------------------------------------------")
print("              LocalHERA Part 15 Complete!                 ")
print("                    Please check !                        ")
print("----------------------------------------------------------")